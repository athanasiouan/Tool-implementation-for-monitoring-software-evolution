...
public class thirdLaw extends JFrame {
    ...
    public thirdLaw(int [] operation, int [] data, History h) {
        setTitle("Third Law");
        ...
        //create charts
        JFreeChart lineChart1 = ChartFactory.createLineChart("Operations Growth", "Version ID", "Growth", createDataset(operation),PlotOrientation.VERTICAL, false, true, false);
        JFreeChart lineChart2 = ChartFactory.createLineChart("Data Structures Growth", "Version ID", "Growth", createDataset(data),PlotOrientation.VERTICAL, false, true, false);
