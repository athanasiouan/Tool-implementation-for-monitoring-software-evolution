...
public class fourthLaw extends JFrame {
    ...
    public fourthLaw(double [] operation, double[] data, History h) {
		setTitle("Fourth Law");
	    ...
	    //create charts
	    JFreeChart lineChart1 = ChartFactory.createLineChart("Operations Work Rate", "Version ID", "Work Rate", createDataset(operation),PlotOrientation.VERTICAL, false, true, false);
	    JFreeChart lineChart2 = ChartFactory.createLineChart("Data Structures Work Rate", "Version ID", "Work Rate", createDataset(data),PlotOrientation.VERTICAL, false, true, false);
    ...
    private CategoryDataset createDataset(double [] temp) {
